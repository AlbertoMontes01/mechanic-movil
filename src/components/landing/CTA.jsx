  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16">
      <div className="rounded-2xl border border-primary/30 bg-primary/10 p-8 text-center">
        {/* Pricing/trial version -- swap back in when ready:
        <h2 className="font-display text-3xl font-bold uppercase tracking-tight">Start today. Free for 30 days.</h2>
        <p className="mt-3 text-muted-foreground">Create your account in 2 minutes. Card required — nothing charged for 30 days.</p>
        */}
